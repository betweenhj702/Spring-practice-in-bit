...
public class BoardServiceImpl implements BoardService {
	...
	@Override
	public BoardListResult getBoardListResult(String keyword, int cp, int ps) {
		long totalCount = boardMapper.selectCountByWriter(keyword);
		BoardVo boardVo = new BoardVo(keyword, cp, ps);
